...
pacman -Syu plasma plasma-wayland-session kde-gtk-config sddm sddm-kcm kdeconnect kdegraphics-thumbnailers ffmpegthumbs redshift kdenetwork-filesharing powerdevil flatpak packagekit packagekit-qt5 spectacle ark okular vlc kate konsole dolphin discover okular firefox libreoffice-fresh-pt-br;
